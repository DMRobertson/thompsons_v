...
def test(aut):
	...
	endpoints = term + init
	for x in aut.quasinormal_basis:
		ctype, _, _ = aut.orbit_type(x)
		if not (ctype.is_type_B() and x in endpoints):
			continue
