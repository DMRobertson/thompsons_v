...
\item \label{it:terminal_banks}
	...
	\begin{enumerate}
		...
		\item At this stage, we should have $\Gamma'$ and $w_i'$ such that $w_i' = \ell\Gamma'\phi^k\a i \in X$ belongs to a doubly-infinite orbit (for some $k$). \marginnote{We may have had to concatenate the strings $\Gamma$ and $\a j$ from previous steps to obtain $\Gamma'$.} Record the tuple $(\ell, \Gamma'\alpha_i)$.
	\end{enumerate}
