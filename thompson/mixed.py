...
class MixedAut(Automorphism):
	...
	def free_factor(self, generators, infinite=False):
		...
		:returns: The transformed automorphism :math:`\phi\, \in G_{n, s}`. Its type is :class:`~thompson.periodic.PeriodicAut` if *infinite* is False; otherwise its type is :class:`~thompson.infinite.InfiniteAut`.
	...
	def test_power_conjugate_to(self, other, cheat=False):
		...
		.. seealso:: This is an implementation of Algorithm :paperref:`powerconjAlgorithm` in the paper. It depends on Algorithms :paperref:`conjAlgorithm` (the :meth:`conjugacy test <test_conjugate_to>`) and :paperref:`alg:pcRI` (the :meth:`infinite power conjugate test <thompson.infinite.InfiniteAut.find_power_conjugators>`.)
		"""
